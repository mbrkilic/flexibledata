      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p >
            ...
            pariatur, dignissimos animi natus ipsa possimus consequatur, sit
            aliquid, laborum suscipit deleniti maxime sunt? Consectetur hic
            magnam deleniti sapiente, quod vel?
          </p>
